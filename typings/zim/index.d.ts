...
declare function zogl(item1:any, ...item2:any):string;
declare function zogd(item1:any, ...item2:any):string;
...
declare var interstellar:string;
...
declare function getTIME(time?:number, timeType?:string, minWarning?:number, maxWarning?:number, noWarning?:boolean):string
declare function checkTIME(time?:number, timeChar?:string, minWarning?:number, maxWarning?:number):void
...
declare function sortObject(obj:{}, property:string, reverse?:boolean):{}
...
declare function makeMath():void
...
declare function unicodeToUTF(val:string):string;
...
declare function zimEase(points:[any], polynomials?:[any], reverse?:boolean, lockEnds?:boolean):Function;
declare function spline(points:[any], tension?:number, close?:boolean, shape?:Shape, removeLast?:boolean):string;
...
declare class CustomShape extends Container implements zimShape {
...
declare class TextureActive extends Page implements zimComponent {
...
declare class TextureActives extends createjs.EventDispatcher {
...
declare class TextureActivesManager extends createjs.EventDispatcher {
...
declare class Pack extends Container {
...
declare class Timeline extends Container {
...
// ++++++++++++++++++++++++++++++++++++++
// ZIM PIZZAZZ 
declare function makeShape(type?:string, color?:color, width?:number, height?:number):Shape
declare function makeIcon(type?:string, color?:color, scale?:number, multi?:number, multiAlpha?:number, multiScale?:number, multiX?:number, multiY?:number, skewX?:number, skewY?:number, backing?:DisplayObject):Container
declare function makePattern(type?:string, colors?:color|zimVee, size?:number, cols?:number, rows?:number, spacingH?:number, spacingV?:number, interval?:number, startPaused?:boolean, backgroundColor?:number, gradient?:number, cache?:boolean):Container
...
// ++++++++++++++++++++++++++++++++++++++
// ZIM GAME 
declare class LeaderBoard extends Container {
...
declare class Meter extends Label {
...
declare class Board extends Container {
...
declare class Person extends Container {
...
declare class Orb extends Container {
...
declare class Tree extends Container {
    constructor()
    readonly boardCol:number
    readonly boardRow:number
    readonly moving:boolean
...
declare class Timer extends Label {
...
declare class Scorer extends Label {
...
declare class Dialog extends Container {
...
// ++++++++++++++++++++++++++++++++++++++
// ZIM CAM 
declare class Cam extends Container {
...
declare class CamMotion extends Container {
...
declare class CamCursor extends Container {
...
declare class CamAlpha extends Container {
...
declare class CamControls extends List {
...
declare class CamAsk extends Pane {
